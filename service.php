...
<div id="testimonial-carousel" class="carousel slide" data-ride="false">
  <div class="carousel-inner">
    ...
    <div class="carousel-item container-fluid">
      <h2 class="testimonial-text">The apartment restaurant with both indoor and outdoor seating offers an open-buffet breakfast </h2>
...
<div class="container marketing p-5">
        ...
        <div class="row ">
          <div class="col-lg-4">
            ...
            <p>Pay visit onsite after booking has been completed</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details »</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
          <img  src="assets/picture/icons/online-appointment.png" alt="Generic placeholder image" width="80" height="80"><br>
            <h2>Online Services</h2>
            <p>Whether you book an apartment online, on the phone, or through a travel agent, it should be a simple process.</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details »</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
