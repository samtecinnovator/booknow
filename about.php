...
<section class="about-section bg-light p-5" >
            <div class="row">
                <div class="col-md-12 col-lg-6 col-sm-12 mt-4">
                    ...
                    <p class="title-para ml-5">The four-star apartment is a jewel
                       of the 19th century architecture, located in the strict centre of Meru, at washington Street. 
                    ...
                    <p class="title-para ml-5">This apartment is not merely the building but, above all, its people.
                       ...
                       and we will be more than happy to organise your meeting – both in our building, in a tent at the apartment's patio, as well as in any other place of your choosing.</p>
                </div>
                <div class="col-md-12 col-lg-6 col-sm-12 d-flex mt-4 pl-5">
                    <img width="400px" height="400px" src="assets/picture/apartment.png">
                </div>
            </div>
 </section>
...
<div class="intro py-5">
                ...
                <p class="text-center">Make the Most Of Your Time in Meru </p>
</div>
<div class="row pb-4">
<div class="col-md-4 col-sm-6">
<ul>
<li>Connect, create and innovate in the flexible meeting venues at our business apartment in Meru</li>
...
<div class="col-md-4 col-sm-6">
<ul>
<li>Host up to 1,200 in the largest, most sophisticated conference venue in downtown Meru</li>
...
<li>Impress your attendees with upscale apartment accommodations amid the best of downtown Madurai
