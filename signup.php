...
<div class="container">
    <div class="row align-items-center my-5">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            ...
            <p class="font-italic text-muted mb-0">Information provided below will be used to sign in to your Bookings account.</p>
            ...
            <form action="register.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                ?>
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="phoneNumber" type="tel" name="contactno"  placeholder="Phone Number" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
