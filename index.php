...
<!-- Carousel  -->
   ...
   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
       ...
       <div class="carousel-inner">
         ...
         <div class="carousel-item ">
           ...
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5 text-dark"> Guest can enjoy their view within their own private room in the apartment</h1>
 ...
 <section class="py-5 white-section" id="introduction" >
   ...
   <div class="container"> 
           ...
           <p class="text-justify">This ornate, palatial tribute to the greatest empires -The pasific - overlooks 
               verdant foliage in the heart of meru. This luxury apartment offers one of the largest banqueting 
               ...
               <p><blockquote class="blockquote">Ideal Location</blockquote>
                       ...
                       The delights of this luxurious apartment are varied. As a fascinating 
    ...
    <section class="py-5 colored-section" id="grid">
         <!-- CHATBOT implemented here -->
    <?php include('chat-online.php');?>
    </section>
   ...
   <section class="py-5 colored-section" id="grid" >
    ...
    <div class="row featurette m-5">
          <div class="col-md-7 container">
            <h1 class="featurette-heading display-5">Managing apartment Facility. <span class="text-muted lead">Space Usage Plan</span></h1>
            <p class="lead">Management of a apartment facility is another important aspect of facility planning that facility planning firms, such as HPG Consulting, handle on a regular basis. The main objective is to ensure seamless coordination among various apartment processes, and business continuity and sustainability. It takes into account apartment space, infrastructure, personnel,
