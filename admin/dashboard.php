...
<div class="col-md-6 col-sm-12">
   ...
   <p class="font-weight-bold">Total Booking</p>
      <p id="room_total_booking">15</p>
      <p class="font-weight-bold">Rejected Booking</p>
      <p id="room_rejeted_booking">5</p>
      <p class="font-weight-bold">Cancalled Booking</p>
      <p id="room_cancelled_booking">2</p>
   </div>
   <div class="col-md-6 col-sm-12">
     
   <p class="font-weight-bold">Booked rooms</p>
      <p id="room_booked_booking">20</p>
      <p class="font-weight-bold">Paid Booking</p>
      <p id="room_paid_booking">7</p>
      <p class="font-weight-bold">Checked Out Booking</p>
      <p id="room_checkedout_booking">5</p>
   </div>
</div>
...
<div class="col-md-6 col-sm-12">
   ...
   <p class="font-weight-bold">Total Booking</p>
      <p id="event_total_booking">15</p>
      <p class="font-weight-bold">Rejected Booking</p>
      <p id="event_rejeted_booking">2</p>
      <p class="font-weight-bold">Cancalled Booking</p>
      <p id="event_cancelled_booking">1</p>
   </div>
   <div class="col-md-6 col-sm-12">
     
   <p class="font-weight-bold">Booked Booking</p>
      <p id="event_booked_booking">10</p>
      <p class="font-weight-bold">Paid Booking</p>
      <p id="event_paid_booking">8</p>
      <p class="font-weight-bold">Checked Out Booking</p>
      <p id="event_checkedout_booking">5</p>
   </div>
</div>
...
<div class="card border-light mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p id="avail_room">16</p>
    
  </div>
</div>
</div>
<div><?php include('charts.php');?></div>
<div class="col-md-4 col-sm-12">
<div class="card border-light mb-3" style="max-width: 18rem;">
