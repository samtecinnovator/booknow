...
<div class="container">
    <div class="row align-items-center my-5">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            ...
            <h1>Book a Room</h1>
            <p class="font-italic text-muted mb-0">Information provided below will be used to book a room in to your Bookings account.</p>
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
            <form action="client_functions.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="bg-white px-4 border-md border-right-0">
                                <i class="fa fa-phone-square text-muted"></i>
                            </span>
                        </div>
                      
                        <input id="contactno" type="tel" name="contactno" placeholder="Phone Number" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
                    </div>
